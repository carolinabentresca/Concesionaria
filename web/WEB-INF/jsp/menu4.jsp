...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <a href="venta4.htm" style="margin-left: 10px;font-family: cursive" class="btn btn-warning">DESTACADOS</a>
        </div>
                        ...
                        <tbody>
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="oferta4.htm?id=${dato.id}"  style="font-family: cursive" class="btn btn-danger text-white">VER</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>

...
<html>
    ...
    <body>
        <div class="card-header bg-dark text-white">
            <h2 style="font-family: cursive">TOYOTA _</h2>
        </div>
        <br/> 
        <br/> 
        <div class="container">
            <a href="menu3.htm"  style="font-family: cursive" class="btn btn-success">MENÚ</a> 
            <a href="contacto3.htm" style="margin-left: 10px;font-family: cursive" class="btn btn-warning ">COTIZACIÓN</a>
        </div>
                ...
                <div class="card-body bg-dark text-white">
                    <table class="table table-hover">
                        <div class="text-white">
                            <h4 style="font-family: cursive">OFERTA TOYOTA </h4>
                        </div>
                        <thead>
                            <tr>
